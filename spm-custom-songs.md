...
## Prerequisites 
For this tutorial, you will need to install [Dolphin Emulator](https://dolphin-emu.org/download) if you don't have it installed already, download the [Super Paper Mario HD Audio mod](https://youtu.be/IvLNpXvohTw),* and obtain a Super Paper Mario ISO file. You can either dump a legally-obtained game from a real console using a [Homebrew Channel](https://wiibrew.org/wiki/Homebrew_Channel) app, or you can find a ROM online.

You also need to have the song(s) you want to add to the game as audio files (MP3, WAV, or OGG will all work). If you want a song from a YouTube video, I recommend either [yt-dlp](https://ytdlp.online) (more options) or [CNVMP3](https://cnvmp3.com) (easier to use).
